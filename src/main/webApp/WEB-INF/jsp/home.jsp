               ...
               <div class="col-md-6">
                 <div class="tm-section-text-container">
                   <i class="tm-text-white">
                     <p class="mb-0">
                       We at Freshness@Doorstep beleives in Spreading happiness through providing
                        all the required material to our customers
                       at cost Friendly as well as in ecofriendly manner.
                       Here you can find all dairy products at you doorstep.
                       We are just a Registeration away.
                        </p>
                   </i>
                 </div>
               </div>
               ...
               <div class="col-md-12 col-lg-6">
                 <div class="tm-section-text-container-2">
                   ...
                   <div class="tm-text-gray">
                     <p class="mb-4">
                        Here, you can find all milk Products at a single place.
                     </p>
                     <p class="mb-0">
